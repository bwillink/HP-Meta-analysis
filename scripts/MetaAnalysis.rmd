...
x <-
  c(
    "metafor", "kableExtra", "Matrix", "dplyr", "wesanderson", "weightr", "ggplot2", "bbmle", "MuMIn", "glmulti")
...
res <- glmulti(g ~ Trait.type*Gradient.category-1, 
               ...
               method = "ML")
# --> Check warnings: Redundant predictors dropped from the model. 
# summary
print(res)
...
plot(res, type="s")
# --> none of them reach to over 0.8
...
```{r}
# Without Q3m2.1
AICtab(Q3m1, Q3m2.2, Q3m3, Q3m4, Q3m5, Q3m6, Q3m7, mnames = LETTERS[1:7], delta = TRUE, weights = TRUE)
# Without Q3m2.1 and Q3m7
AICtab(Q3m1, Q3m2.2, Q3m3, Q3m4, Q3m5, Q3m6, mnames = LETTERS[1:6], delta = TRUE, weights = TRUE)
```
#### Model inference
```{r}
full_model <- rma.mv(
