...
Q2 <-
  rma.mv(
    g ~ Trait.type:Gradient.category -1,
    V = varcovmat_2_PD$mat,
    random = list( ~ 1 | Experiment, ~1 | ID, ~ 1 | Parasite),
    data = dat_2,
    method = "REML",
)
...
Q1.uni <-
  rma.uni(
    g ~ Trait.type:Gradient.category + Experiment + ID + Parasite.type ,
    vi = dat_1$var.g,
    data = dat_1,
    method = "REML"
  )
...
orchard_plot(Q1, mod = "var.g", xlab = "Standardised mean difference", transfm = "none", angle = 45, alpha = 0.7)+
